...
def process_audio(mapped_events: List[Dict[str, Any]], scaling_factor: float, sound_folder: str, output: str, input_basename: str):
    """
    ...
    max_time = max(e["timestamp"] for e in mapped_events) * scaling_factor * 1000  # in ms
